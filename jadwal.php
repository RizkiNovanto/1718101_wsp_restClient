<h1 class="h3 mb-4 text-gray-800 text-center text-primary"><strong>Jadwal</strong></h1>
<br><br><br>
...
<table class="table">
    <thead>
        <tr>
            ...
            <th scope="col">nama_masjid</th>
            <th scope="col">alamat_masjid</th>
            ...
            <div class="modal-body">
                <form id="formMsjadz">
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Pilih Ustadz</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" name="createMulai" id="exampleFormControlInput1" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Waktu Selesai</label>
                        <input type="time" class="form-control" name="createSelesai" id="exampleFormControlInput1" placeholder="">
                    </div>
                    <div class="form-group">
